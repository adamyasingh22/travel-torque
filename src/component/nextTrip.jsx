    ...
    return (
      <div className=" mt-12 md:mx-32 font-serif max-sm:text-center">
        ...
        <div className="relative max-sm:mt-8 max-sm:m-4 text-white">
            <img className="rounded-2xl md:h-[194px] md:w-[95%]" src="../../public/images/sydney.jpg" alt/>
        ...
        <div className="relative max-sm:mt-8 max-sm:mx-4 text-white">
            <img className="rounded-2xl md:h-[194px] md:w-[95%]" src="../../public/images/beaches.jpg" alt/>
            <div className="absolute bottom-4 mx-2">
        ...
        <div className="relative max-sm:mt-8 max-sm:mx-4 text-white">
            <img className="rounded-2xl md:h-[194px] md:w-[95%]" src="../../public/images/dubai.jpg" alt/>
            <div className="absolute bottom-4 mx-2">
