...
const Checkout = () =>{
   ...
   return (
    <div className="bg-[#F4F4F4]">
        ...
        <p className="mx-32 text-3xl font-serif mt-12 -mb-8 font-semibold">Secure your reservation</p>
        </div>
        <Alert/>
        <div className="mx-32 my-8 md:flex md:justify-center ">
        <div className="w-2/3 mr-8">


                <div className=" md:mb-8">
                <div className="bg-[#2F80ED] flex justify-start items-center p-3  rounded-t-xl text-white ">
                    ...
                    <p className="md:ml-8">2 adults, 1 double bed and 1 twin bed, Non-smoking</p>
                </div>
                <div className="bg-white rounded-b-xl md:p-8">
                <div className="md:flex  md:items-center font-sans">
                <div className="md:mx-4 md:my-4 ">
                    <p className="font-medium my-1">First Name</p>
                    <input className="bg-gray-100 rounded-md p-1" value="" placeholder=""></input>
                </div>
                <div className="md:mx-4 ">
                    <p className="font-medium my-1">Last Name</p>
                    <input className="bg-gray-100 rounded-md p-1" value="" placeholder=""></input>
                </div>
                </div>
                <div className="font-sans md:w-2/3">
                <div className="md:mx-4 mb-4">
                    <p className="font-medium my-1">Mobile Number</p>
                ...
                <div className="bg-[#2F80ED] flex justify-start items-center p-3  rounded-t-xl text-white ">
                    ...
                    <p className="md:ml-8 font-mono"> Special Offer(Book Now Pay Later)</p>
                </div>
                <div className="bg-white rounded-b-xl md:p-8 ">
                
                <div className="font-serif md:w-2/3 " >
                <div className="md:mx-4 mb-4">
                    <p className="font-medium my-1 font-sans">Enter you UPI Id</p>
                    <input className="bg-gray-100 md:w-2/3 rounded-md p-1" value="" placeholder=""></input>
                </div>
                ...
                <div className="bg-[#333333] text-white w-1/2 my-8 text-center px-auto py-4 rounded-xl">
                ...
                <div className="bg-[#F2C94C]  p-4  rounded-t-xl text-[#333333] ">
                ...
                <div className="md:mx-4 mb-4">
                    ...
                    <ol className="font-medium my-1 font-sans list-disc list-inside">
                        <li className="my-4">This rate is non-refundable. If you change or cancel your booking you will not &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; get a refund or credit to use for a future stay</li>
                    ...
                    <p className="my-8 text-[#4F4F4F] text-sm p-4">By clicking the button below, I acknowledge that I have reviewed the <span className="text-[#2F80ED]">Privacy Statement</span> and have reviewd and accept the <span className="text-[#2F80ED]">Rules and Restrictions</span> and <span className="text-[#2F80ED]">Terms of Use</span>.</p>

                    <div className=" w-1/3 bg-[#2F80ED] font-sans p-4 text-center rounded-xl">
                       Complete Booking
                    </div>
         ...
         <div className="w-1/3">
               ...
               <div className="bg-white pb-2 rounded-md mb-12">
                <img className="rounded-t-xl" src="../../public/images/checkout1.jpg"/>
               ...
               <div className="font-serif mb-36">
                <p className="bg-[#85E0AB] py-2 px-8 font-semibold rounded-t-md">
                 Price Details
                </p>
                <div className="bg-white rounded-b-md p-4 text-[#4F4F4F] ">
                    ...
                    <p className="text-sm my-1 text-black font-semibold">Coupon code</p>
                    <div className="my-2">
