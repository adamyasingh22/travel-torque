...
const Hdetail = () => {
    ...
    return (
        <div className="bg-[#F4F4F4]">
         <Header/>
         {/* photo gallery start */}
         <div className="md:mx-32 md:flex md:p-8 max-sm:px-2">
            <div className="md:w-2/3 md:p-4 max-sm:p-2">
                <img className="max-sm:rounded-2xl" src="../../public/images/detail.jpg" alt=""/>
            </div>
            <div className="md:w-1/3">
                <div className="md:p-4 max-sm:p-2">
                    <img className="max-sm:rounded-2xl" src="../../public/images/detail-1.jpg" alt=""/>
                </div>
                <div className="md:p-4 max-sm:p-2">
                    <img className="max-sm:rounded-2xl" src="../../public/images/detail-2.jpg" alt=""/>
                </div>
         ...
         {/* photo gallery end */}
         {/* short nav start */}
         <div className="md:mx-32 flex text-[#333333] border-b-2 max-sm:m-2 p-4 space-x-8 tracking-normal font-semibold bg-white max-sm:rounded-2xl md:rounded-3xl max-sm:justify-center max-sm:items-center">
         ...
         <div className="md:mx-32 md:p-8 md:flex">
            <div className="md:w-2/3 max-sm:p-4">
                ...
                <div className="py-8 max-sm:px-8 bg-white max-sm:mt-3 md:mt-8 rounded-xl md:p-4 ">
                   ...
                   <div className="mt-8">
                    <div className="md:flex md:items-center md:space-x-16 max-sm:space-y-3">
                    <p className="flex">
                        <span className="mx-4">
                   ...
                   <div className="md:mt-4 max-sm:mt-3">
                    <div className="md:flex md:items-center md:space-x-16 max-sm:space-y-3">
                    <p className="flex">
                        <span className="mx-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                   ...
                   <div className="md:my-4 max-sm:mt-3">
                    <div className="md:flex md:items-center md:space-x-16 max-sm:space-y-3">
                    <p className="flex">
                        <span className="mx-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
            ...
            <div className="md:w-1/3 mx-4">
                ...
                <div className="p-4">
                   <p className="max-sm:font-sans max-sm:font-semibold">Explore the area</p>
                   <div className="flex space-x-12 mt-4">
                    <p className="flex items-center ">
                        ...
                        Hotel Penselvenyia</p>
                    <p className="max-sm:mx-auto">2 min drive</p>
                   </div>
                   <div className="flex md:space-x-12 mt-2">
                    <p className="flex items-center">
                            <svg className="md:mr-4 max-sm:mr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        Travis Bakery store </p>
                    <p className="max-sm:mx-auto">10 min drive</p>
                   </div>
                   <div className="flex md:space-x-8 md:mt-4 max-sm:mt-2">
                    <p className="flex items-center ">
                            <svg className="md:mr-4 max-sm:mr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M2.84484 11.4817L1.6665 12.66L5.79067 14.4275L7.559 18.5525L8.73734 17.3742L8.14817 14.4275L10.909 11.6667L13.9173 18.0867L15.0332 16.9708L14.0415 8.53499L16.3982 6.17749C16.5574 6.02375 16.6843 5.83984 16.7717 5.6365C16.859 5.43316 16.905 5.21446 16.9069 4.99316C16.9088 4.77186 16.8667 4.5524 16.7829 4.34757C16.6991 4.14274 16.5753 3.95666 16.4188 3.80017C16.2623 3.64368 16.0763 3.51992 15.8714 3.43612C15.6666 3.35232 15.4471 3.31015 15.2258 3.31207C15.0045 3.314 14.7858 3.35998 14.5825 3.44732C14.3792 3.53467 14.1952 3.66164 14.0415 3.82083L11.6223 6.23999L3.1865 5.24749L2.13234 6.30249L8.50234 9.36082L5.7915 12.0717L2.84484 11.4817Z" fill="#4F4F4F"/>
                            </svg>
                        Olivia Johnson Garden</p>
                    <p className="max-sm:mx-auto">15 min drive</p>
                   </div>
                   <div className="flex md:space-x-12 md:mt-4 max-sm:mt-2">
                    <p className="flex items-center ">
                            <svg className="md:mr-4 max-sm:mr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M2.84484 11.4817L1.6665 12.66L5.79067 14.4275L7.559 18.5525L8.73734 17.3742L8.14817 14.4275L10.909 11.6667L13.9173 18.0867L15.0332 16.9708L14.0415 8.53499L16.3982 6.17749C16.5574 6.02375 16.6843 5.83984 16.7717 5.6365C16.859 5.43316 16.905 5.21446 16.9069 4.99316C16.9088 4.77186 16.8667 4.5524 16.7829 4.34757C16.6991 4.14274 16.5753 3.95666 16.4188 3.80017C16.2623 3.64368 16.0763 3.51992 15.8714 3.43612C15.6666 3.35232 15.4471 3.31015 15.2258 3.31207C15.0045 3.314 14.7858 3.35998 14.5825 3.44732C14.3792 3.53467 14.1952 3.66164 14.0415 3.82083L11.6223 6.23999L3.1865 5.24749L2.13234 6.30249L8.50234 9.36082L5.7915 12.0717L2.84484 11.4817Z" fill="#4F4F4F"/>
                            </svg>
                        Norman Opera Circus</p>
                    <p className="max-sm:mx-auto">18 min drive</p>
                   </div>
                   <div className="flex md:space-x-12 md:mt-4 max-sm:mt-2">
                    <p className="flex items-center ">
                            <svg className="md:mr-4 max-sm:mr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        Rockdeset hotel</p>
                    <p className="max-sm:mx-auto">32 min drive</p>
                   </div>
                </div>
            </div>
         </div>
           <div className="md:mx-32 md:mt-8 p-4">
                 ...
                 <div className="md:flex ">
                    <div className="md:flex md:items-center md:w-1/3 p-8 ">
                    ...
                    <div className="md:w-1/3 md:p-8">
                        ...
                        <div className="bg-white md:pl-4 pb-4 rounded-b-3xl ">
                            ...
                            <div className="bg-[#2F80ED] p-2 m-4 text-center rounded-3xl ">Reserve suite</div>
