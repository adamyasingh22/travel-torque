const Login = () => {
    return (
      <div className="h-screen w-full bg-gray-100">
        <div className="max-sm:ml-6 max-sm:mt-3 flex max-md:flex-grow max-md:ml-24 max-md:mt-3 max-md:ml-24 max-lg:flex-grow max-lg:ml-24 max-lg:mt-3 bg-white">
          ...
          <p className="font-serif max-sm:mr-2 text-[#726c6c] md:mr-4">my Dream Place</p>
        </div>
        <div className="flex flex-col h-5/6 mt-8 w-96 px-8 self-center  rounded-xl mx-auto md:shadow-lg bg-white pt-8">
            ...
            <div className="flex justify-start pt-1">
              ...
              <a class="text-[#2F80ED]" href="">Register</a>
            </div>
        </div>
      </div>
    )
