    ...
    if(email != "" && password != ""){
      ...
      for(let i=0;i<token.length;i++){
        if(token[i].email == email && token[i].password == password){
          ...
          window.location = "/"
          localStorage.setItem("islogin",JSON.stringify({"status" : true , "email" : email}))
      ...
      <div className="h-screen w-full bg-gray-100">
        ...
        <div className="flex flex-col h-5/6 mt-8 w-96 px-8 self-center  rounded-xl mx-auto md:shadow-lg bg-white pt-8">
            ...
            <div className="flex flex-col justify-center  w-full">
                ...
                <input type={pass ? "text" : "password"}  value={password} className="bg-gray-100  px-4 py-1 w-full rounded-md" onChange={(e)=>setPassword(e.target.value)}></input>
